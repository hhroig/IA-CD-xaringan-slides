...
```
.center[
r4ds **gratis** en: <https://r4ds.had.co.nz/index.html>.
]
...
#### Pasamos al mini-**Notebook de Visualización**
...
* Excepción: uso limitado con `ggplot` (y aún [`ggvis`](https://ggvis.rstudio.com/) está verde).
]]
